...
const storage = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, "upload/images"); // your folder
  },
...
// creating endpoint for registering thwe user
...
// ccreating end point for popular in women
    ...
    const fetchUser=async (req,res,next)=>{
      ...
      if(!token){
        ...
        try {
          ...
          res.status(401).send({errors:"please authenicate wit valid token"})
        }
      }
    }


// creating end pointt for adding products in cartData
